...
const OnboardingPlansTable = ({ data }: { data: Array<any> }) => {
  ...
  return (
    <BaseCard className="px-10 py-5">
      ...
      <div className="py-2.5 text-textLightColor text-base font-semibold flex flex-row align-middle items-center px-1.5 gap-3.5 cursor-pointer">
      ...
      <div>
        {tableData.map((item, index) => (
          <div key={item.applicant}>
            <div className="flex flex-row align-middle items-center py-2.5 px-1.5 gap-1.5 cursor-pointer hover:bg-primary_3">
